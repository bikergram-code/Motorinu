...
/// We store as String now. Legacy ints are converted via toString().
 String get id; String get email; String get username; String? get displayName; String? get bikername; String? get avatarUrl; String? get avatarUrlCargram; String? get bio; String? get postalCode; String? get community; String? get language; int? get age; int? get birthYear; int? get motoStartAge; int? get carStartAge; bool get hasTrackExperience; int get experienceYears; bool get trackExperience; int get bikeCount; List<String> get diySkills; int get xpTotal; int get level; int get followerCount; int get followingCount; int get postCount; int get rideCount; bool get isPremium; bool get isBusiness; bool get isVerified; String? get stripeCustomerId; DateTime? get lastActiveAt; DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,email,username,displayName,bikername,avatarUrl,avatarUrlCargram,bio,postalCode,community,language,age,birthYear,motoStartAge,carStartAge,hasTrackExperience,experienceYears,trackExperience,bikeCount,const DeepCollectionEquality().hash(diySkills),xpTotal,level,followerCount,followingCount,postCount,rideCount,isPremium,isBusiness,isVerified,stripeCustomerId,lastActiveAt,createdAt]);

@override
String toString() {
  return 'User(id: $id, email: $email, username: $username, displayName: $displayName, bikername: $bikername, avatarUrl: $avatarUrl, avatarUrlCargram: $avatarUrlCargram, bio: $bio, postalCode: $postalCode, community: $community, language: $language, age: $age, birthYear: $birthYear, motoStartAge: $motoStartAge, carStartAge: $carStartAge, hasTrackExperience: $hasTrackExperience, experienceYears: $experienceYears, trackExperience: $trackExperience, bikeCount: $bikeCount, diySkills: $diySkills, xpTotal: $xpTotal, level: $level, followerCount: $followerCount, followingCount: $followingCount, postCount: $postCount, rideCount: $rideCount, isPremium: $isPremium, isBusiness: $isBusiness, isVerified: $isVerified, stripeCustomerId: $stripeCustomerId, lastActiveAt: $lastActiveAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String email, String username, String? displayName, String? bikername, String? avatarUrl, String? avatarUrlCargram, String? bio, String? postalCode, String? community, String? language, int? age, int? birthYear, int? motoStartAge, int? carStartAge, bool hasTrackExperience, int experienceYears, bool trackExperience, int bikeCount, List<String> diySkills, int xpTotal, int level, int followerCount, int followingCount, int postCount, int rideCount, bool isPremium, bool isBusiness, bool isVerified, String? stripeCustomerId, DateTime? lastActiveAt, DateTime? createdAt
});
...
as int?,hasTrackExperience: null == hasTrackExperience ? _self.hasTrackExperience : hasTrackExperience // ignore: cast_nullable_to_non_nullable
...
as bool,stripeCustomerId: freezed == stripeCustomerId ? _self.stripeCustomerId : stripeCustomerId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String username,  String? displayName,  String? bikername,  String? avatarUrl,  String? avatarUrlCargram,  String? bio,  String? postalCode,  String? community,  String? language,  int? age,  int? birthYear,  int? motoStartAge,  int? carStartAge,  bool hasTrackExperience,  int experienceYears,  bool trackExperience,  int bikeCount,  List<String> diySkills,  int xpTotal,  int level,  int followerCount,  int followingCount,  int postCount,  int rideCount,  bool isPremium,  bool isBusiness,  bool isVerified,  String? stripeCustomerId,  DateTime? lastActiveAt,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.displayName,_that.bikername,_that.avatarUrl,_that.avatarUrlCargram,_that.bio,_that.postalCode,_that.community,_that.language,_that.age,_that.birthYear,_that.motoStartAge,_that.carStartAge,_that.hasTrackExperience,_that.experienceYears,_that.trackExperience,_that.bikeCount,_that.diySkills,_that.xpTotal,_that.level,_that.followerCount,_that.followingCount,_that.postCount,_that.rideCount,_that.isPremium,_that.isBusiness,_that.isVerified,_that.stripeCustomerId,_that.lastActiveAt,_that.createdAt);case _:
  return orElse();
...
class _User implements User {
  const _User({required this.id, required this.email, required this.username, this.displayName, this.bikername, this.avatarUrl, this.avatarUrlCargram, this.bio, this.postalCode, this.community, this.language, this.age, this.birthYear, this.motoStartAge, this.carStartAge, this.hasTrackExperience = false, this.experienceYears = 0, this.trackExperience = false, this.bikeCount = 0, final  List<String> diySkills = const [], this.xpTotal = 0, this.level = 1, this.followerCount = 0, this.followingCount = 0, this.postCount = 0, this.rideCount = 0, this.isPremium = false, this.isBusiness = false, this.isVerified = false, this.stripeCustomerId, this.lastActiveAt, this.createdAt}): _diySkills = diySkills;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,email,username,displayName,bikername,avatarUrl,avatarUrlCargram,bio,postalCode,community,language,age,birthYear,motoStartAge,carStartAge,hasTrackExperience,experienceYears,trackExperience,bikeCount,const DeepCollectionEquality().hash(_diySkills),xpTotal,level,followerCount,followingCount,postCount,rideCount,isPremium,isBusiness,isVerified,stripeCustomerId,lastActiveAt,createdAt]);
