...
// ─── Blitzer Settings Screen ─────────────────────────────────────────────────
//
// Full settings panel for the Blitzer/Navigation system.
// Accessible from: Speed-Dial → Einstellungen, or Settings → Blitzer
//
// Sections:
// 1. Warnungen (Alert types, distances, stages)
// 2. Audio & Vibration
// 3. Fahrmodus (Driving mode settings)
// 4. Navigation
// 5. Batterie (Performance vs battery)

class BlitzerSettingsScreen extends ConsumerWidget {
  const BlitzerSettingsScreen({super.key});
      ...
      body: settingsAsync.when(
        ...
        data: (settings) => ListView(
          ...
          children: [
            ...
            // ─── Link zu Navigationseinstellungen ─────────────
            _Card(
              cardColor: cardColor,
              children: [
                InkWell(
                  onTap: () => context.push('/navigation-settings'),
                  ...
                  child: Padding(
                    ...
                    child: Row(children: [
                      Container(
                        ...
                        child: const Icon(Icons.navigation_rounded, color: Colors.teal, size: 18),
                      ),
                      const SizedBox(width: 14),
                      Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Navigationseinstellungen', style: GoogleFonts.inter(
                            fontSize: 15, fontWeight: FontWeight.w500, color: textColor,
                          )),
                          Text('Fahrmodus, Route, Orte, Darstellung', style: GoogleFonts.inter(
